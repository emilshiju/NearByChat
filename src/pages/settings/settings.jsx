...
useEffect(() => {
  ...
  return () => {
    ...
    return (
      ...
      >
        <form className="w-full max-w-lg px-4 lg:px-0"> {/* Added padding for smaller screens */}
...
>
  ...
  >
    ...
    />
        ...
        <div className="hidden lg:block h-[200px] w-[1px] bg-black ml-20"></div> {/* Hidden divider on smaller screens */}
    
        {responsiveMd&&<div className="ml-2 mt-6 lg:mt-0"> {/* Added margin-top for smaller screens */}
          <div
