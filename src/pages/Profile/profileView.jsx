...
const profileView = () => {
  ...
  const getConnectionStatus = () => {
    api
      .get(`/checkConnectionStatus?userId=${userInfo._id}&id=${receiverId}`)
      .then((res) => {
              ...
              <header className="flex flex-wrap items-center p-4 md:py-8">
                ...
                <div className="w-8/12 md:w-7/12 ml-4">
                  ...
                  <div className="hidden md:block">
                    ...
                    <input type="text" className="block" value={bio} />
                  </div>
                </div>
              ...
              <div style={{ paddingLeft: "320px" }}>
                {userStatus && userStatus?.status == "false" && (
                  <button
                    ...
                    onClick={() =>
                      connectButton(userInfo.userName, userInfo._id, receiverId)
                    }
                  >
                    Connect
                  </button>
