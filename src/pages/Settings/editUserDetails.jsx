...
const EditUserDetails = () => {
  ...
  const onSubmitUserDetails = (e) => {
    ...
    api
      .put("/editUserDetails", { userId, userName, dob, gender })
      .then((res) => {
        if (res.data.status) {
          showToastMessage();
          getUserDetails();
    ...
    console.log(
      "userrrrrrrrrrrrrrrrrrrrrrrrrr deeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
    );
    ...
    <>
      <div>
        ...
        <div
          ...
          style={{
            paddingLeft: open ? "350px" : responsiveMd ? "110px" : "20px",
            marginTop: "100px",
          }}
        >
                ...
                <div className="w-full px-3">
                  ...
                  {showCheckPasswordError && (
                    <p className="text-red-500 text-xs pt-2 italic">
                      Password is wrong try again or forgotPassword
                    </p>
                  )}
                </div>
