...
<div className="bg-gray-200 h-[200px] md:h-[330px] w-full rounded-lg shadow-md flex items-center justify-center">
  {!change ? (
    <div role="status" className="flex flex-col items-center justify-center">
      <svg
        aria-hidden="true"
        className="w-24 h-24 md:w-32 md:h-32 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
        viewBox="0 0 100 101"
        fill="none"
    ...
    <video className="w-full h-full rounded-lg object-cover" ref={remoteVideo} autoPlay playsInline />
  )}
</div>
  ...
  {/* <!-- Mobile Next Button --> */}
  <button className="bg-sky-500 text-white text-2xl block md:hidden mt-1"   onClick={handleSkip}>
    Next <PlayCircleFilledWhiteIcon style={{ fontSize: 28 }} />
  </button>
