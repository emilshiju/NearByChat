...
const ConnectingToRandomPepole = () => {
  ...
  async function makeCall() {
    ...
    console.log(receiver.current);
    console.log(
      "finishiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii"
    );
      ...
      <div className="grid grid-cols-1 md:grid-cols-[2fr,3fr] gap-4 flex-grow">
        ...
        <div className="hidden sm:flex flex-col flex-grow bg-white rounded shadow-lg relative overflow-y-auto  md:block">
          <div className="flex justify-start mb-4 p-4">
            <button
              className="bg-sky-500 text-white text-3xl px-10 py-2 rounded flex items-center"
              onClick={handleSkip}
            >
          ...
          <div className="w-full px-4 absolute bottom-0 left-0 right-0">
            <div className="flex items-center space-x-4">
              <input
                className="flex-1 border border-blue-400 bg-white border-opacity-40 rounded px-3 py-2 outline-none"
                type="text"
                placeholder="Enter text..."
                value={currentMessage}
                onChange={onChagneCurrentMessage}
        ...
        {/* <!-- Mobile Next Button --> */}
        <button
          className="bg-sky-500 text-white text-2xl block md:hidden mt-1 w-full h-10"
          onClick={handleSkip}
        >
          Next <PlayCircleFilledWhiteIcon style={{ fontSize: 28 }} />
        </button>
